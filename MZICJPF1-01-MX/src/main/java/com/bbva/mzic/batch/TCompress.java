...
public class TCompress implements Tasklet, StepExecutionListener {

	private static final Logger LOGGER = LoggerFactory.getLogger(TCompress.class);

	private CompressManager compressManager;

	public TCompress(CompressManager compressManager) {
